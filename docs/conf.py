...
# -*- coding: utf-8 -*-
#
# citelang documentation build configuration file, created by
...
project = "CiteLang Python"
copyright = "2022, Vanessa Sochat"

from citelang import version  # noqa
...
texinfo_documents = [
    (
        ...
        ["Vanessa Sochat"],
        "citelang",
        "CiteLang is a citation and credit markdown syntax",
        "Miscellaneous",
    ),
]
